...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return calculateSeekAngularVelocity; });\n/* harmony import */ var _movement_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./movement_utils */ \"./client/movement_utils.js\");\n\n\nfunction calculateSeekAngularVelocity(\n  currentRotation, currentPosition, destinationPosition,\n) {\n  const angularVelocityScalar = 100;\n  const destAngle = _movement_utils__WEBPACK_IMPORTED_MODULE_0__[\"calculateRotationAngle\"](currentPosition, destinationPosition);\n\n  let angularVelocity = _movement_utils__WEBPACK_IMPORTED_MODULE_0__[\"directionToRotate\"](currentRotation, destAngle) * angularVelocityScalar;\n\n  const distanceToRotate = _movement_utils__WEBPACK_IMPORTED_MODULE_0__[\"distanceToRotate\"](currentRotation, destAngle);\n  if (distanceToRotate < angularVelocityScalar / 60 * Math.PI / 180) {\n    angularVelocity = angularVelocity / angularVelocityScalar\n        * distanceToRotate * 60 * 180 / Math.PI;\n  }\n\n  return angularVelocity;\n}\n\n\n//# sourceURL=webpack:///./client/seek_movement.js?");
